...
| R-08 | **Bus factor = 1** — sole maintainer | H | M | Documentation layer (architecture, BRs, ADRs, STATUS dossiers, white paper) written to make the project survivable; open source (GPL-2.0) makes forks possible; funding (NLnet/VLAIO) buys maintainer time | Partially mitigated — this documentation push is the mitigation |
