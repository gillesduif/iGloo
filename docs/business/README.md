...
| Document | Contents |
|---|---|
| [use-cases.md](use-cases.md) | Actors and use cases (UC-01 …), with main scenarios and extensions |
| [business-rules.md](business-rules.md) | The rule catalog (BR-01 …): every hard constraint, its rationale, and where the code enforces it |
